    ...
    public partial class second : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Flights", x => x.AirplaneID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users_", x => x.EGN);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Flights_FlightAirplaneID",
                        column: x => x.FlightAirplaneID,
                        principalTable: "Flights",
                        principalColumn: "AirplaneID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reservations_Users__UserEGN",
                        column: x => x.UserEGN,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_FlightAirplaneID",
                table: "Reservations",
                column: "FlightAirplaneID");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_UserEGN",
                table: "Reservations",
                column: "UserEGN");
        }
